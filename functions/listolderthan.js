...
export default function(msg,client) {
    msg.reply(`**listolderthan** has been depreciated and will be removed soon. Please use **listusers** to list users with >. Refer to the help command for a list of current functions.\n\n**listusers > 2 months**`);
}